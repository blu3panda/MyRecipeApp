    ...
    return [
      ...
      new Food(
        ...
        [
          ...
          "Add the blanched pork, shaoxing wine, light soy sauce, dark soy sauce and water. Stir and bring the mixture to a boil. Once boiling, add the spices, along with the peeled hardboiled eggs and turn the heat to the lowest setting. Simmer for 1.5 hours, stirring occasionally to prevent sticking.",
      ...
      new Food(
        ...
        [
            ...
            "Meanwhile, bring a large pot of water to a boil. With ten minutes or so left for the sauce to cook, add the spaghetti and cook for 1 minute less than the directions on the package.",
